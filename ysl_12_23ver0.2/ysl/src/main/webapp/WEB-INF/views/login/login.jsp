...
<body>
	...
	<form:form class="form-signin" name="form" id="form" role="form"
		...
		<div class="text-center mb-4">
			<h1 class="h3 mb-3 font-weight-normal">BOARD.COM</h1>
		</div>
		...
		<button class="btn btn-lg btn-primary btn-block" type="button" onclick="location.href='/login/signupForm'">Sign up</button>
